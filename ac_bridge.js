...
(function (Il2Cpp) {
    ...
    Il2Cpp.exports = {
        get alloc() {
            return r("TyfsfLvTLsH", "pointer", ["size_t"]);
        },
        get arrayGetLength() {
            return r("wavEbpRu_kc", "uint32", ["pointer"]);
        },
        get arrayNew() {
            return r("ajIUEvepvjz", "pointer", ["pointer", "uint32"]);
        },
        get assemblyGetImage() {
            return r("NVhjaP_fKbm", "pointer", ["pointer"]);
        },
        get classForEach() {
            return r("CUjkkJPLCIo", "void", ["pointer", "pointer"]);
        },
        get classFromName() {
            return r("DyqLHZfPQla", "pointer", ["pointer", "pointer", "pointer"]);
        },
        get classFromObject() {
            return r("lXDIxuAjzEy", "pointer", ["pointer"]);
        },
        get classGetArrayClass() {
            return r("fyWKQ_UqCAX", "pointer", ["pointer", "uint32"]);
        },
        get classGetArrayElementSize() {
            return r("XIijwRwwNPP", "int", ["pointer"]);
        },
        get classGetAssemblyName() {
            return r("rnBRuysFGvG", "pointer", ["pointer"]);
        },
        get classGetBaseType() {
            return r("ildNJreQEoi", "pointer", ["pointer"]);
        },
        get classGetDeclaringType() {
            return r("VPEWGPKBOfx", "pointer", ["pointer"]);
        },
        get classGetElementClass() {
            return r("NKSAJdb_xHd", "pointer", ["pointer"]);
        },
        get classGetFieldFromName() {
            return r("kwKtPwrsCDY", "pointer", ["pointer", "pointer"]);
        },
        get classGetFields() {
            return r("AoQgoyRtnYs", "pointer", ["pointer", "pointer"]);
        },
        get classGetFlags() {
            return r("xek_HSADwGX", "int", ["pointer"]);
        },
        get classGetImage() {
            return r("Hi_EuMmSYwX", "pointer", ["pointer"]);
        },
        get classGetInstanceSize() {
            return r("NovRQgEkrcK", "int32", ["pointer"]);
        },
        get classGetInterfaces() {
            return r("MjOFCeeqyYe", "pointer", ["pointer", "pointer"]);
        },
        get classGetMethodFromName() {
            return r("YRGq_SyOBUy", "pointer", ["pointer", "pointer", "int"]);
        },
        get classGetMethods() {
            return r("DfVt_Tthxqk", "pointer", ["pointer", "pointer"]);
        },
        get classGetName() {
            return r("GiyAxvEikoR", "pointer", ["pointer"]);
        },
        get classGetNamespace() {
            return r("bXPQayDOAen", "pointer", ["pointer"]);
        },
        get classGetNestedClasses() {
            return r("LGtaKOTC_BI", "pointer", ["pointer", "pointer"]);
        },
        get classGetParent() {
            return r("fxZiqksFvvY", "pointer", ["pointer"]);
        },
        get classGetStaticFieldData() {
            return r("rOuxTIXTtXD", "pointer", ["pointer"]);
        },
        get classGetValueTypeSize() {
            return r("zOynwMyaejB", "int32", ["pointer", "pointer"]);
        },
        get classGetType() {
            return r("KkCezRfKYcB", "pointer", ["pointer"]);
        },
        get classHasReferences() {
            return r("LtWhdOCeLLJ", "bool", ["pointer"]);
        },
        get classInitialize() {
            return r("qaIBsBPQADN", "void", ["pointer"]);
        },
        get classIsAbstract() {
            return r("MGuEQTFMDyH", "bool", ["pointer"]);
        },
        get classIsAssignableFrom() {
            return r("OOWUitUDyyS", "bool", ["pointer", "pointer"]);
        },
        get classIsBlittable() {
            return r("HPeUxeldkRW", "bool", ["pointer"]);
        },
        get classIsEnum() {
            return r("dpnDIhLomrU", "bool", ["pointer"]);
        },
        get classIsGeneric() {
            return r("HncVkoyfoYP", "bool", ["pointer"]);
        },
        get classIsInflated() {
            return r("obAXZEaZTCl", "bool", ["pointer"]);
        },
        get classIsInterface() {
            return r("Q_VDhlFjFCj", "bool", ["pointer"]);
        },
        get classIsSubclassOf() {
            return r("pphXyulfyir", "bool", ["pointer", "pointer", "bool"]);
        },
        get classIsValueType() {
            return r("UczhzuaadzZ", "bool", ["pointer"]);
        },
        get domainGetAssemblyFromName() {
            return r("bqjTMWijrcM", "pointer", ["pointer", "pointer"]);
        },
        get domainGet() {
            return r("botIOVynBEM", "pointer", []);
        },
        get domainGetAssemblies() {
            return r("jQgdRxMcVBj", "pointer", ["pointer", "pointer"]);
        },
        get fieldGetClass() {
            return r("cQElersVflm", "pointer", ["pointer"]);
        },
        get fieldGetFlags() {
            return r("oZDQtNtsdZT", "int", ["pointer"]);
        },
        get fieldGetName() {
            return r("jPoaRLOXzvg", "pointer", ["pointer"]);
        },
        get fieldGetOffset() {
            return r("gjuWjQiEcTU", "int32", ["pointer"]);
        },
        get fieldGetStaticValue() {
            return r("iJftufNyHsV", "void", ["pointer", "pointer"]);
        },
        get fieldGetType() {
            return r("SgNhzdPIDQm", "pointer", ["pointer"]);
        },
        get fieldSetStaticValue() {
            return r("cqSRpvcBNyh", "void", ["pointer", "pointer"]);
        },
        get free() {
            return r("srBMFXGFgOL", "void", ["pointer"]);
        },
        get gcCollect() {
            return r("BJBbnvHvZgX", "void", ["int"]);
        },
        get gcCollectALittle() {
            return r("SLRgvWzPNXJ", "void", []);
        },
        get gcDisable() {
            return r("nOMcITnINJd", "void", []);
        },
        get gcEnable() {
            return r("cEURkfudHRC", "void", []);
        },
        get gcGetHeapSize() {
            return r("hCQSyU_smRt", "int64", []);
        },
        get gcGetMaxTimeSlice() {
            return r("RmPGuUzhMvj", "int64", []);
        },
        get gcGetUsedSize() {
            return r("AhlmpndnbXA", "int64", []);
        },
        get gcHandleGetTarget() {
            return r("bLJDEdKmBcS", "pointer", ["uint32"]);
        },
        get gcHandleFree() {
            return r("zIUICTOsSFq", "void", ["uint32"]);
        },
        get gcHandleNew() {
            return r("yuvjUlaFBA_", "uint32", ["pointer", "bool"]);
        },
        get gcHandleNewWeakRef() {
            return r("tGeBJKTMUsS", "uint32", ["pointer", "bool"]);
        },
        get gcIsDisabled() {
            return r("GjFUMUriaQX", "bool", []);
        },
        get gcIsIncremental() {
            return r("cOAXqtybgqb", "bool", []);
        },
        get gcSetMaxTimeSlice() {
            return r("MroijyvnRSk", "void", ["int64"]);
        },
        get gcStartIncrementalCollection() {
            return r("JcXWvhsbLv_", "void", []);
        },
        get gcStartWorld() {
            return r("ekAEvsmxMSk", "void", []);
        },
        get gcStopWorld() {
            return r("csbMrKBOhLw", "void", []);
        },
        get getCorlib() {
            return r("toRkmTJjlOQ", "pointer", []);
        },
        get imageGetAssembly() {
            return r("ImJJQdOJDFq", "pointer", ["pointer"]);
        },
        get imageGetClass() {
            return r("bDkcNMzZJpa", "pointer", ["pointer", "uint"]);
        },
        get imageGetClassCount() {
            return r("hUHSWWziuaN", "uint32", ["pointer"]);
        },
        get imageGetName() {
            return r("kWsGbmJTXJp", "pointer", ["pointer"]);
        },
        get initialize() {
            return r("fsWDWrgEkfB", "void", ["pointer"]);
        },
        get livenessAllocateStruct() {
            return r("gmfUpxekuBJ", "pointer", ["pointer", "int", "pointer", "pointer", "pointer"]);
        },
        ...
        get livenessCalculationFromStatics() {
            return r("XCQCUBUkgly", "void", ["pointer"]);
        },
        get livenessFinalize() {
            return r("pUkujxxDGaP", "void", ["pointer"]);
        },
        get livenessFreeStruct() {
            return r("eWLpasiKrfN", "void", ["pointer"]);
        },
        get memorySnapshotCapture() {
            return r("fKcQGrASvfv", "pointer", []);
        },
        get memorySnapshotFree() {
            return r("YNDutsvLnoP", "void", ["pointer"]);
        },
        ...
        get methodGetClass() {
            return r("ZrYsLlwIqiv", "pointer", ["pointer"]);
        },
        get methodGetFlags() {
            return r("rkTUDnAePRy", "uint32", ["pointer", "pointer"]);
        },
        get methodGetName() {
            return r("TJrfAlWOrUu", "pointer", ["pointer"]);
        },
        get methodGetObject() {
            return r("HPoWQITgPXq", "pointer", ["pointer", "pointer"]);
        },
        get methodGetParameterCount() {
            return r("edvcOJegUaz", "uint8", ["pointer"]);
        },
        get methodGetParameterName() {
            return r("SBwXfbOJGfd", "pointer", ["pointer", "uint32"]);
        },
        get methodGetParameters() {
            return r("il2cpp_method_get_parameters", "pointer", ["pointer", "pointer"]);
        },
        get methodGetParameterType() {
            return r("RieNEqQJpTT", "pointer", ["pointer", "uint32"]);
        },
        get methodGetReturnType() {
            return r("zZcUOoUbEgM", "pointer", ["pointer"]);
        },
        get methodIsGeneric() {
            return r("rNGM_ODIdRY", "bool", ["pointer"]);
        },
        get methodIsInflated() {
            return r("XVhBukdDbJH", "bool", ["pointer"]);
        },
        get methodIsInstance() {
            return r("iIHbGVaahZe", "bool", ["pointer"]);
        },
        get monitorEnter() {
            return r("XarDwnrKall", "void", ["pointer"]);
        },
        get monitorExit() {
            return r("UOsMNJPvCmN", "void", ["pointer"]);
        },
        get monitorPulse() {
            return r("cOmVxXkRTmw", "void", ["pointer"]);
        },
        get monitorPulseAll() {
            return r("oTBIW_MrETO", "void", ["pointer"]);
        },
        get monitorTryEnter() {
            return r("iaFmiMOFhzT", "bool", ["pointer", "uint32"]);
        },
        get monitorTryWait() {
            return r("ZvlAQMGxYRX", "bool", ["pointer", "uint32"]);
        },
        get monitorWait() {
            return r("CymQINhZOwa", "void", ["pointer"]);
        },
        get objectGetClass() {
            return r("npmCfJxNrXA", "pointer", ["pointer"]);
        },
        get objectGetVirtualMethod() {
            return r("byAFR__PYxx", "pointer", ["pointer", "pointer"]);
        },
        get objectInitialize() {
            return r("snyPEajAWhc", "void", ["pointer", "pointer"]);
        },
        get objectNew() {
            return r("qArnlAJWEnK", "pointer", ["pointer"]);
        },
        get objectGetSize() {
            return r("XtpZzIhWknI", "uint32", ["pointer"]);
        },
        get objectUnbox() {
            return r("HxYPyYVftyR", "pointer", ["pointer"]);
        },
        get resolveInternalCall() {
            return r("mQmAoWuTmoa", "pointer", ["pointer"]);
        },
        get stringGetChars() {
            return r("_qvESwFSEav", "pointer", ["pointer"]);
        },
        get stringGetLength() {
            return r("lcNLnKyDtjn", "int32", ["pointer"]);
        },
        get stringNew() {
            return r("tQZwFachSst", "pointer", ["pointer"]);
        },
        get valueTypeBox() {
            return r("HfHgjOMVNzV", "pointer", ["pointer", "pointer"]);
        },
        get threadAttach() {
            return r("BUFyOSOnlCd", "pointer", ["pointer"]);
        },
        get threadDetach() {
            return r("GXDJQBeOLBu", "void", ["pointer"]);
        },
        get threadGetAttachedThreads() {
            return r("il2cpp_thread_get_all_attached_threads", "pointer", ["pointer"]);
        },
        get threadGetCurrent() {
            return r("evYGsSaW_yZ", "pointer", []);
        },
        get threadIsVm() {
            return r("yIJsXZmRkTB", "bool", ["pointer"]);
        },
        get typeEquals() {
            return r("GckqBHdiLzN", "bool", ["pointer", "pointer"]);
        },
        get typeGetClass() {
            return r("lfxRstYCaro", "pointer", ["pointer"]);
        },
        get typeGetName() {
            return r("RFnEOeZmnW_", "pointer", ["pointer"]);
        },
        get typeGetObject() {
            return r("asmSrJwFwBx", "pointer", ["pointer"]);
        },
        get typeGetTypeEnum() {
            return r("nhBeoHQWnTl", "int", ["pointer"]);
        }
    };
